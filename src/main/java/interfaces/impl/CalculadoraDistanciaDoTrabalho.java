    ...
    public void calculaBonus(@NotNull Funcionario funcionario) {
        try {
            if (funcionario.getDistanciaDoTrablaho() <= 50)
                funcionario.addBonus(new Bonus("Distancia50km", 1.01));
            else if (funcionario.getDistanciaDoTrablaho() <= 100)
                funcionario.addBonus(new Bonus("Distancia100km", 1.03));
            else if (funcionario.getDistanciaDoTrablaho() <= 150)
                funcionario.addBonus(new Bonus("Distancia150km", 1.05));
            else if (funcionario.getDistanciaDoTrablaho() > 150)
                funcionario.addBonus(new Bonus("MaiorDistancia150km", 1.07));
        } catch (Exception e) {
